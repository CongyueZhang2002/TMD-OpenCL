...
Params = make_params([0.232, 1.1, 0.0194, 0.171, 0.115, 0.00894, 1.83, 3.42, 2.34, 1.27, 0.0949, 7.82])

#---------------------------------------------------------------------------------------------------------------------
#   Build OpenCL program
#---------------------------------------------------------------------------------------------------------------------

source_NP = read(abspath(joinpath(@__DIR__, "..", "TMDs", "NP Parameterizations", "NP-Default.cl")), String)
