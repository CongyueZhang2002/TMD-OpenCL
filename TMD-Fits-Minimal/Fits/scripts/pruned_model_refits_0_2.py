...
RESULTS_DIR = RESULTS_ROOT / "pruned_model_refits_0_2_results"
...
CASES = [
    PruneCase(
        ...
        base_result_path=RESULTS_ROOT / "power_table_refit_results" / "baseline_unfrozen__MSHT20N3LO-MC-0-2.json",
    ...
    PruneCase(
        ...
        base_result_path=RESULTS_ROOT / "power_table_refit_results" / "poly_bstar_cslog__MSHT20N3LO-MC-0-2.json",
        fixed_map={"alpha": 1.0},
    ),
    PruneCase(
        ...
        base_result_path=RESULTS_ROOT / "power_table_refit_results" / "poly_bstar_cslog_loggauss__MSHT20N3LO-MC-0-2.json",
