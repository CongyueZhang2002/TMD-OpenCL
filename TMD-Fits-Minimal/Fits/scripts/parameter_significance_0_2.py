...
try:
    ...
    deprecated_scripts = FITS_DIR / "deprecated" / "scripts"
...
RESULTS_DIR = RESULTS_ROOT / "parameter_significance_0_2_results"
...
MODELS = [
    ModelConfig(
        ...
        result_path=RESULTS_ROOT / "power_table_refit_results" / "baseline_unfrozen__MSHT20N3LO-MC-0-2.json",
    ),
    ModelConfig(
        ...
        result_path=RESULTS_ROOT / "power_table_refit_results" / "poly_bstar_cslog__MSHT20N3LO-MC-0-2.json",
    ),
    ModelConfig(
        ...
        result_path=RESULTS_ROOT / "power_table_refit_results" / "poly_bstar_cslog_loggauss__MSHT20N3LO-MC-0-2.json",
    ),
]
