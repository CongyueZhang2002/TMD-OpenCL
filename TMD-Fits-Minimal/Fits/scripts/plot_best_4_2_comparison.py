...
OUT_DIR = RESULTS_ROOT / "model_comparison_plots" / "best_4_2_comparison"
DATA_ROOT = FITS_DIR.parent / "Data" / "Default" / "Cutted" / "DY"

SHORTLIST = {
    "poly_bstar_cslog_loggauss": {
        "result_path": RESULTS_ROOT / "localized_shape_followup_results" / "poly_bstar_cslog_loggauss.json",
        "label": "0-2 loggauss",
        "color": "tab:green",
        "linestyle": "-",
    },
    "reduced_loggauss_powerseed": {
        "result_path": RESULTS_ROOT / "bump_variant_followup_results" / "reduced_loggauss_powerseed.json",
        "label": "0-2 powerseed",
        "color": "tab:blue",
        "linestyle": "--",
    },
