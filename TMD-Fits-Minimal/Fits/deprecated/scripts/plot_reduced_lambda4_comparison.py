...
from parameter_significance_reduced_0_2 import MODELS, make_spec


OUT_DIR = FITS_DIR / "model_comparison_plots" / "reduced_lambda4_comparison"
...
CANDIDATES = {
    ...
    "reduced_lambda4_zero": {
        "label": "Reduced loggauss, lambda4=0",
        "color": "tab:red",
        "linestyle": "--",
    },
}
...
def reduced_model():
    return next(model for model in MODELS if model.name == "poly_bstar_cslog_loggauss_reduced")
