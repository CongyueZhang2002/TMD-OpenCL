...
FITS_DIR = ROOT / "Fits"
RESULTS_DIR = ROOT / "Fits" / "parameter_significance_reduced_0_2_results"
...
MODELS = [
    ReducedModel(
        ...
        result_path=ROOT / "Fits" / "pruned_model_refits_0_2_results" / "poly_bstar_cslog_alpha1.json",
    ),
    ReducedModel(
        ...
        result_path=ROOT / "Fits" / "pruned_model_refits_0_2_results" / "poly_bstar_cslog_loggauss_lambda3_0_alpha1.json",
    ),
]
